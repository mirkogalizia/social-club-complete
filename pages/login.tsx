  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center">
      <div className="bg-gray-800 p-8 rounded-xl shadow-md w-full max-w-sm">
        ...
        <button onClick={handleLogin} className="w-full bg-white text-black py-2 rounded font-semibold hover:bg-gray-200">Entra</button>
        <p className="text-center mt-4 text-sm text-gray-400">Non hai un account? <Link href="/signup" className="underline">Registrati</Link></p>
      </div>
    </div>
  );
}
